...
from concat_baseline.concat_baseline import Rectangle, pallet_placement, assign_coordinates, rects_flatten


def concat_placement(pallet_width: int, pallet_height: int, items: List[Item],
